...
class AutomateBase :
    ...
    def __init__ (self, listTransitions, listStates=None, label=None) :
        ...
        self.listStates = self.getListStates()
    ...
    def getAlphabetFromTransitions(self):
        ...
        """
        # E : set[str]
        E = {t.etiquette for t in self.listTransitions}
        # reconversion en liste
        return [eti for eti in E]
    ...
    def getListStates(self):
        ...
        """
        # states : set[State]
        states = { s for s in self.listStates}
        # t : Transition
    ...
    def removeState(self, state) :
        ...
        if state in self.listStates :
                cp=copy.copy(self.listTransitions)
                for t in cp :
